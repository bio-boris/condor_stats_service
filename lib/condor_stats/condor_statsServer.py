...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'condor_stats'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from condor_stats.condor_statsImpl import condor_stats  # noqa @IgnorePep8
impl_condor_stats = condor_stats(config)
...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_condor_stats.queue_status,
                             ...
                             types=[dict])
        self.method_authentication['condor_stats.queue_status'] = 'required'  # noqa
